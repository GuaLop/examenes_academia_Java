...
/**se implementa la interfaz "EstacionesAño" a la clase "Primavera"*/
public class Primavera implements EstacionesAño {
    ...
    public void tipoDeEstacion() {
        System.out.println("Es primavera y las flores están floreciendo");
